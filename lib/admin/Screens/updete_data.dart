...
class UpdeteData extends StatefulWidget {
  UpdeteData({
    super.key,
    this.idDoc,
    this.senddata,
  ...
  static const String id = '/UpdeteData';

  @override
  State<UpdeteData> createState() => _UpdeteDataState();
}

class _UpdeteDataState extends State<UpdeteData> {
...
//********** */
  ...
  void initState() {
    ...
    controllerofficeAddress.text = widget.senddata!.officeAddress;
    controllerprofile.text = widget.senddata!.profile;
    controlleruniversty.text = widget.senddata!.universty;
    controllerfieldOfStude.text = widget.senddata!.fieldOfStude;
    controllerdegree.text = widget.senddata!.degree;
    controllerinstitution.text = widget.senddata!.institution;
    controllerposition.text = widget.senddata!.position;
    controllercategory.text = widget.senddata!.category;
    controllerspecialisty.text = widget.senddata!.specialisty;
    controllerexpiryBoard.text = widget.senddata!.expiryBoard;
    controllerexpiryCurrent.text = widget.senddata!.expiryCurrent;

    imageUrl = widget.senddata!.urlImage;
    selectitemsgender = widget.senddata!.gender;
    selectStartEd = widget.senddata!.startYearEdiction;
    selectEndEd = widget.senddata!.endYearEdiction;
    selectStartWo = widget.senddata!.startYearWork;
    selectEndWo = widget.senddata!.endYearWork;
    super.initState();
  }
